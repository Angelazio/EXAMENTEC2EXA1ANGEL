...
import com.emergentes.modelo.GestorProduc_aCoronel;
import com.emergentes.modelo.Produc_aCoronel;
...
public class Controller extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Produc_aCoronel objProducto = new Produc_aCoronel();
        int id, pos;
        ...
        if(op.equals("nuevo"))
        {
            ...
            GestorProduc_aCoronel produc =(GestorProduc_aCoronel) ses.getAttribute("produc");
